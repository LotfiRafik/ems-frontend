...
export function createDaysForNextMonth(year, month, currentMonthDays) {
  ...
  const lastDayOfTheMonthWeekday = getWeekday(
    // TODO refactor => currentMonthDays[-1] last item in the list
    // instead on constructing the date manually 
...
export function isInInterval(startDate, endDate, dateToCheck){
